  ...
  def calc: Long = {
    def num4(n1: Int, n2: Int, n3: Int, n4: Int): List[Int] = {
      List(
        ...
        num3(n1, n2, n4).flatMap(num2(n3, _)),
        num3(n1, n3, n4).flatMap(num2(n2, _)),
        num3(n2, n3, n4).flatMap(num2(n1, _)),
        num2(n1, n2).flatMap(r1 => num2(n3, n4).flatMap(r2 => num2(r1, r2))),
        num2(n1, n3).flatMap(r1 => num2(n2, n4).flatMap(r2 => num2(r1, r2))),
        num2(n1, n4).flatMap(r1 => num2(n2, n3).flatMap(r2 => num2(r1, r2)))
      ).flatten
    }

    def num3(n1: Int, n2: Int, n3: Int): List[Int] = {
      List(
        num2(n1, n2).flatMap(num2(n3, _)),
        num2(n1, n3).flatMap(num2(n2, _)),
        num2(n2, n3).flatMap(num2(n1, _))
      ).flatten
    }

    def num2(n1: Int, n2: Int): List[Int] = {
      operations.flatMap(op => List(op(n1, n2), op(n2, n1)).flatten).filter(_ > 0)
    }

    def operations =
      List(
        (a: Int, b: Int) => List(a + b),
        (a: Int, b: Int) => List(a - b),
        (a: Int, b: Int) => List(a * b),
        (a: Int, b: Int) => if (b == 0 || a % b != 0) Nil else List(a / b)
      )
